...
# 使用本地数据路径
SMOLTALK_BASE_DIR = "/public_hw/share/cit_ztyu/cz/nanochat/base_data"
...
class SmolTalk(Task):
    ...
    def __init__(self, split, **kwargs):
        ...
        # 使用本地数据
        if split == "train":
            ds_path = os.path.join(SMOLTALK_BASE_DIR, "smoltalk_train")
        else:
            ds_path = os.path.join(SMOLTALK_BASE_DIR, "smoltalk_test")
