"""
TACO (Topics in Algorithmic Code generation) dataset for RL training.
...
class TACO(Task):
    """TACO algorithmic coding dataset for RL training."""

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ds_path = os.path.join(BASE_DIR, "taco_train")
